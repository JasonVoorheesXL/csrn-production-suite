...
def main() -> int:
    ...
    requirements = {
        ...
        "consumer connect buttons": "Connect ${escapeHtml(provider.label)}" in setup,
        ...
        "X PKCE": all(value in oauth for value in ("code_challenge_method", '"S256"', "offline.access", "media.write")),
...
- Added X OAuth 2.0 PKCE and Facebook OAuth broker onboarding boundaries.
- Added Windows DPAPI protected credential storage, connection tests, and disconnect controls.
...
""",
    ...
    print("Live Connect X and Connect Facebook require registered PossumFrog provider applications; Facebook also requires the OAuth broker.")
    return 0
