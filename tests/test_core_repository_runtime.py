...
def fake_module(tmp_path: Path):
    ...
    module = SimpleNamespace(
        ...
        RUNTIME_VERSION="Version 1.13.0-alpha.5f — Broadcast Package and Lifecycle Routes",
...
def test_config_identity_is_supplied_by_repository(tmp_path: Path) -> None:
    ...
    assert config["application"]["build"] == "V1.13A5F-BROADCAST-PACKAGE-AND-LIFECYCLE-ROUTES"
